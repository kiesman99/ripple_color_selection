...
void main() {
  ...
  test('ColorSelectionValue with parameter', (){
    ColorSelectionValue value = ColorSelectionValue(selectedColor: Colors.green);
  ...
  test('ColorSelectionController with parameter', (){
    ColorSelectionController controller = ColorSelectionController(value: ColorSelectionValue(selectedColor: Colors.green));
